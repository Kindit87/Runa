package org.kindit.runa.lavaplayer;
...
public class PlayerManager {
    ...
    public GuildMusicManager getMusicManager(Guild guild) {
        return this.musicManagers.computeIfAbsent(
            ...
            guildID -> {
                ...
                guild
                    .getAudioManager()
                    .setSendingHandler(guildMusicManager.sendHandler);
        ...
        this.audioPlayerManager.loadItemOrdered(
            ...
            new AudioLoadResultHandler() {
                ...
                public void trackLoaded(AudioTrack audioTrack) {
                    ...
                    hook
                        .sendMessageEmbeds(
                            getEmbedBuilderForTrack(audioTrack, musicManager)
                        )
                        .queue();
                }
    ...
    private MessageEmbed getEmbedBuilderForPlayList(
        ...
        eb.setTitle(
            "Добавлено в очередь: " + tracks.size() + " чего-то там...",
            trackURL
        );
    ...
    @NotNull
    private MessageEmbed getEmbedBuilderForTrack(
    ...
    public void queueLoop(TextChannel textChannel) {
        ...
        musicManager.scheduler.isQueueLoop =
            !musicManager.scheduler.isQueueLoop;
    }
